...
ACTION_STATE_CLASS: dict[str, str] = {
    ...
    "SANDBOX_SETUP_REQUIRED": "ACTION_REQUIRED",
    "RESTART_SANDBOX": "ACTION_REQUIRED",
...
_ACTION_COPY: dict[str, tuple[str, str]] = {
    ...
    "SANDBOX_SETUP_REQUIRED": ("Thiếu cấu hình Sandbox", "Repo này chưa khai báo sandbox: contract trong PROJECT.yaml."),
    "RESTART_SANDBOX": ("Cần khởi động lại Sandbox", "Sandbox từ lần chạy trước vẫn còn dùng được -- khởi động lại thay vì tạo mới."),
